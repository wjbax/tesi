...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 22 16:27:56 2024
...
general_path_to_save = "D:/DATASET_Tesi_marzo2024_RESULTS_AGOSTO/V02/"
...
for subset in tqdm(["test", "val"]):
    ...
    for image in tqdm(os.listdir(general_dataset_path + "DATASET_2classes/" + subset + "/" + "manual/")):
        ...
        PERT_mask_2c = wjb_functions.mask_union_gen_2c(PERT_path_2c)
        MC_mask_2c = wjb_functions.mask_union_gen_2c(MC_path_2c)
        ...
        MC_unc_map = wjb_functions.binary_entropy_map(MC_softmax_matrix[:,:,1,:])
        PERT_unc_map = wjb_functions.binary_entropy_map(PERT_softmax_matrix[:,:,1,:])
