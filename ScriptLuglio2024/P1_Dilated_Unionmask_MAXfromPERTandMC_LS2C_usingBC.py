# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 18:00:58 2024
...
general_path_to_save = "D:/DATASET_Tesi_marzo2024_RESULTS_V17_V2BC/"
...
for subset in tqdm(["test", "val"]):
    ...
    for image in tqdm(os.listdir(general_dataset_path + "DATASET_2classes/" + subset + "/" + "manual/")):
        ...
        MC_unc_map_2c = wjb_functions.mean_softmax_BC_2(MC_softmax_matrix_2c)
        ...
        PERT_unc_map_2c = wjb_functions.mean_softmax_BC_2(PERT_softmax_matrix_2c)
