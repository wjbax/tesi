# -*- coding: utf-8 -*-
"""
Created on Fri Jul 12 00:35:29 2024
...
for dataset in ["Renal PAS glomeruli/", "Renal PAS tubuli/"]:
    ...
    general_path_to_save = "D:/DATASET_Tesi_marzo2024_RESULTS_V20/"
    ...
    for subset in tqdm(["test", "val"]):
        ...
        for image in tqdm(os.listdir(general_dataset_path + "DATASET/" + subset + "/" + "manual/")):
            ...
            for th in th_range:
                ...
                GT_union_th_dice_array_C1_MC.append(wjb_functions.dice(GT_mask_th_union_C1_MC, GT_mask_C1))
                GT_mask_th_union_C2_MC = mask_union_C2_MC.astype(bool) & (unc_map_C2_MC<=th)
                GT_union_th_dice_array_C2_MC.append(wjb_functions.dice(GT_mask_th_union_C2_MC, GT_mask_C2))
                GT_mask_th_union_C1_PERT = mask_union_C1_PERT.astype(bool) & (unc_map_C1_PERT<=th)
                GT_union_th_dice_array_C1_PERT.append(wjb_functions.dice(GT_mask_th_union_C1_PERT, GT_mask_C1))
                GT_mask_th_union_C2_PERT = mask_union_C2_PERT.astype(bool) & (unc_map_C2_PERT<=th)
                GT_union_th_dice_array_C2_PERT.append(wjb_functions.dice(GT_mask_th_union_C2_PERT, GT_mask_C2))
