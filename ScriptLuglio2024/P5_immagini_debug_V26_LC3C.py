...
for dataset in ["Liver HE steatosis/"]:
    ...
    dataset_name = "Liver HE steatosis 3C/"
    ...
    general_results_path_2c = general_dataset_path + "k-net+swin/TEST_3classes/RESULTS"
    general_results_path_3c = general_dataset_path + "k-net+swin/TEST_3classes/RESULTS"
    ...
    for subset in tqdm(["test", "val"]):
        ...
        image_path = os.listdir(general_dataset_path + "DATASET_3classes/" + subset + "/" + "manual/")

        
        for image in tqdm(image_path):
            
            GT_path_2c = general_dataset_path + "DATASET_3classes/" + subset + "/" + "manual/" + image
            OR_path_2c = general_dataset_path + "DATASET_3classes/" + subset + "/" + "image/" + image
            OR_path_3c = general_dataset_path + "DATASET_3classes/" + subset + "/" + "image/" + image
            ...
            if C1_exist:
                ...
                plt.subplot(345)
                plt.title("Best Perturbation Mask, dice = " + str(max_dice_PERT_C1)[:5])
                plt.imshow(PERT_masked_image_C1)
                plt.subplot(349)
                plt.title("Best Montecarlo Mask, dice = " + str(max_dice_MC_C1)[:5])
            ...
            if C2_exist:
                ...
                plt.subplot(345)
                plt.title("Best Perturbation Mask, dice = " + str(max_dice_PERT_C2)[:5])
                plt.imshow(PERT_masked_image_C2)
                plt.subplot(349)
                plt.title("Best Montecarlo Mask, dice = " + str(max_dice_MC_C2)[:5])
                plt.imshow(MC_masked_image_C2)
                plt.subplot(3,4,10)
                plt.title("Bin Ent Uncertainty Map MC")
