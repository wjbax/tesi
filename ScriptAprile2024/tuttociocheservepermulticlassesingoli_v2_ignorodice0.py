# -*- coding: utf-8 -*-
"""
Created on Mon May 27 11:21:19 2024
...
for dataset in tqdm(dataset_dict):
    for subset in tqdm(['val', 'test']):
        ...
        subset_save_path = "D:/DATASET_Tesi_Marzo2024_RESULTS_V7/"+dataset+"/"+subset+"/"
        ...
        for name in tqdm(image_list):
            ...
            save_path = "D:/DATASET_Tesi_Marzo2024_RESULTS_V7/"+dataset+"/"+subset+"/"+name+"/"
...
# %%
        ...
        dice_values_tosave = {
            "list_of_images_to_use": list_of_images_to_use,
        ...
        plt.close()
        plt.plot(np.arange(len(list_of_images_to_use)), mean_MC_dice_C1)
        plt.plot(np.arange(len(list_of_images_to_use)), mean_PERT_dice_C1)
        plt.plot(np.arange(len(list_of_images_to_use)),
        ...
        plt.plot(np.arange(len(list_of_images_to_use)), mean_MC_dice_C2)
        plt.plot(np.arange(len(list_of_images_to_use)), mean_PERT_dice_C2)
        plt.plot(np.arange(len(list_of_images_to_use)),
                  SI_dice_array_C1, linewidth=1, color='r')
        plt.title("Mean Dice per dataset: " + dataset +
