# -*- coding: utf-8 -*-
"""
Created on Mon May 13 16:51:47 2024
...
for p in uncertainty_metric:
    ...
    # %% SOFTMAX MATRIX GENERATOR
                ...
                plt.axhline(y = precision(SI_mask_C2,GT_mask_C2), color = 'g', linestyle = '--')
                ...
                plt.axhline(y = recall(SI_mask_C2,GT_mask_C2), color = 'g', linestyle = '--')
                plt.xlim(0,max_value)
                plt.ylim(top=1)
                plt.legend(['c1 MC','c2 MC', 'c1 PERT', 'c2 PERT'])
